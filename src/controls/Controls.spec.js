...
describe("Button functionality on Control", () => {
  ...
  it("Shows closed when closed button clicked", () => {
    render(<Dashboard />);
  ...
  it("Shows locked when lock button is clicked", () => {
    render(<Dashboard />);
    const controls = render(<Controls />);
    const closeBtn = controls.getByText(/close gate/i);
  ...
  it("Shows unlocked when unlock button is clicked", () => {
    render(<Dashboard />);
    const controls = render(<Controls />);
    const closeBtn = controls.getByText(/close gate/i);
    const lockBtn = controls.getByText(/lock gate/i);
  ...
  it("Shows open when open button clicked", () => {
    render(<Dashboard />);
    const controls = render(<Controls />);
    const closeBtn = controls.getByText(/close gate/i);
    const display = render(<Display />);
